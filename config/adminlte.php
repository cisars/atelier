...
*/
    ...
    'menu' => [
        ...
        ['header' => 'SISTEMA', 'can' => ['admin', 'doc', 'jmec', 'mec', 'fun', 'rec'],],
        [
            'text' => 'SISTEMA',
...
//                ['icon_color' => 'info', 'can' => ['admin', 'doc'], 'url' => '#', 'text' => 'Feriados Laborales',],
        ...
        [
            ...
            'icon_color' => 'maroon',
            'can' => ['admin', 'doc', 'jmec', 'mec', 'rec', 'fun'],
            //'label'         => '1/8',
            'label_color' => 'info',
            'submenu' => [
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec', 'fun'], 'url' => 'reserva', 'text' => 'Reservas',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec', 'fun', 'mec', 'jmec'], 'url' => 'sintoma', 'text' => 'Síntomas de Vehiculos',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec'], 'url' => 'recepcion', 'text' => 'Recepción de Vehiculos',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec', 'jmec', 'mec', 'fun'], 'url' => 'orden_trabajo', 'text' => 'Ordenes de Trabajo',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec', 'jmec' ], 'url' => 'confirmacionot', 'text' => 'Confirmacion de OTs',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'jmec'], 'url' => 'servicios-realizados', 'text' => 'Servicios Realizados',],

                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'jmec'], 'url' => 'verificaciones', 'text' => 'Verificacion de OT ',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'jmec'], 'url' => 'finalizaciones ', 'text' => 'Finalizacion de OT ',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'rec', 'mec', 'jmec'], 'url' => 'entregas', 'text' => 'Entregas de Vehiculos',],
                [
                    'submenu' => [
                        ['url' => 'reserva/create'],
...
//
        ...
        [
            ...
            'icon_color' => 'maroon',
            'can' => ['admin', 'doc', 'mec', 'jmec'],
            //'label'         => '0/3',
            'label_color' => 'info',
            'submenu' => [
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec'], 'url' => 'stock/entradas', 'text' => 'Entrada de Repuestos',],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec'], 'url' => 'stock/salidas', 'text' => 'Salida de Repuestos',],
            ],
        ],
        [
            'text' => 'INFORMES',
            ...
            'icon_color' => 'maroon',
            'can' => ['admin', 'doc', 'mec', 'jmec', 'fun', 'rec'],
            // 'label'         => '0/9',
            'label_color' => 'info',
            'submenu' => [
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec', 'fun'], 'url' => 'exports/stock', 'text' => 'Stock de Manejo', 'target' => '_blank'],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec', 'fun', 'rec'], 'url' => 'exports/entregas', 'text' => 'Entregas de Vehiculos', 'target' => '_blank'],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec', 'mec', 'rec'], 'url' => 'exports/reservas', 'text' => 'Reservas', 'target' => '_blank'],
                ['icon_color' => 'info', 'can' => ['admin', 'doc', 'mec', 'jmec', 'fun', 'rec'], 'url' => 'exports/ots', 'text' => 'Ordenes de Trabajo', 'target' => '_blank'],
...
//                [ 'icon_color' => 'gray',  'can' => ['admin', 'doc'], 'url'=> '#',              'text' => 'Salidas de Repuestos', ],
        ...
        ['header' => 'EJEMPLOS BOOTSTRAP', 'can' => [ 'example-bootstrap'],],
        [
            'text' => 'Datatables',
            'icon' => 'fas fa-fw fa-table',
            'can' => [ 'example-bootstrap'],
            'submenu' => [
