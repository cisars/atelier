    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'can'           => ['admin' ],
            'submenu'       => [
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'usuario',  'text' => 'Usuarios', ],
        ...
        [
            ...
            'can'           => ['admin' ],
            'submenu'       => [
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'sucursal',         'text' => 'Sucursales', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'taller',           'text' => 'Talleres', ],
                [ 'icon_color' => 'gray',    'can' => ['admin'], 'url'=> '#',                'text' => 'Sectores', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'cargo',            'text' => 'Cargos', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'empleado',         'text' => 'Empleados', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'turno',            'text' => 'Turnos', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'grupo',            'text' => 'Grupos de trabajos', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'maquinaria_tipo',  'text' => 'Tipo de Maquinaria', ],
        ...
        [
            ...
            'can'           => ['admin' ],
            'submenu'       => [
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'clasificacion',    'text' => 'Clasificaciones', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'unidad',           'text' => 'Unidades', ],
        ...
        [
            ...
            'can'           => ['admin' ],
            'submenu'       => [
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'localidad',    'text' => 'Localidades', ],
        ...
        [
            ...
            'can'           => ['admin' ],
            'submenu'       => [
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'marca',        'text' => 'Marcas', ],
                [ 'icon_color' => 'gray',    'can' => ['admin'], 'url'=> '#',            'text' => 'Modelos', ],
                [ 'icon_color' => 'gray',    'can' => ['admin'], 'url'=> '#',            'text' => 'Vehiculos', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'color',        'text' => 'Colores', ],
            ],
        ],
        [
            'text'          => 'MOVIMIENTOS',
            ...
            'submenu'       => [
                ...
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> 'sintoma',      'text' => 'Sintomas', ],
                [ 'icon_color' => 'green',  'can' => ['admin'], 'url'=> '#',            'text' => 'Ordenes de Trabajo', ],
