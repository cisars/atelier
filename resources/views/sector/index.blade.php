                ...
                <div class="card card-cyan">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <a  href="{{route('sector.create')}}" class="btn bg-cyan">Nueva Sector</a>
                        ...
                        <table class="table table-sm table-hover nowrap d-table" id="lista">
                            ...
                            @foreach($sectores as $key => $sector)
                                <tr>
                                    ...
                                    <td class=" ">
                                        <a
                                            href="{{ route('sector.edit', $sector->sector) }}"
                                            class= "btn btn-info">
                                        ...
                                        <button
                                            ...
                                            data-toggle ="modal"
                                            data-target ="#modal-danger{{$sector->sector}}"
                                            data-data   ="{{$sector->sector}}">
