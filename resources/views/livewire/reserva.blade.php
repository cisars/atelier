            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-10">
                        ...
                        <input list="browsers" name="cliente_id" id="cliente_id" class="form-control  "
                               wire:model="term" wire:change="selectedClient()">
                        ...
                        <div wire:loading.remove>
                            ...
                            @else
                                    ...
                                    @else
                                        <datalist id="browsers" wire:click="selectedClient()">
                    ...
                    <div class="form-group col-2">
                        ...
                        <input readonly wire:model="termId" id="termId"
