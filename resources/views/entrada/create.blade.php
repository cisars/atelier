                                ...
                                <div class="card-body">
                                    ...
                                    {{--<div class="form-row">--}}
                                        ...
                                        <div class="form-group col">
                                            ...
                                            {!! Form::select('taller_id', Auth::user()->talleres->pluck('descripcion', 'id')  ,
                                                old('taller_id') ,
                                                [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="form-group col">
                                            {{--SELECT FK OT --}}
                                            {!! Form::label('ot_id', 'OT') !!}
                                            {!! Form::select('ot_id', $ordenes_trabajos->pluck('id', 'id')  ,
                                                old('ot_id') ,
                                                [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="form-group col">
                                            ...
                                            <br>
                                            {{ Auth::user()->empleado->nombres. ' ' .  Auth::user()->empleado->apellidos}}
                                        </div>
                                            {{--SELECT FK Empleado ------------------------------------ --}}
