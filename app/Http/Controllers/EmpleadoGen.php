            ...
            [
                ...
                'columnas'  =>
                    [
                        ...
                        $genisa->parametros('ci',               'Cedula de Identidad',  'numeric',  '12,0' , 'notnull','','','','','',''),
                        $genisa->parametros('estado_civil',     'Estado Civil',         'char',     '1',    'notnull','cons','','','estadosciviles','',''),
                        ...
                        $genisa->parametros('telefono',         'Telefono',             'varchar',  '20',   'null',   '','','','','',''),
